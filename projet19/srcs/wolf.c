...
/*   Updated: 2019/02/19 08:13:20 by ebatchas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_variables2(t_wolf *w)
{
	...
	w->sprite_screen = 0;
	w->sprites = NULL;
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(20.5, 11.5), ft_vector(0.0, 0.0), 11));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(18.5, 4.5), ft_vector(0.0, 0.0), 12));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(10.0, 4.5), ft_vector(0.0, 0.0), 10));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(10.5, 12.5), ft_vector(0.0, 0.0), 10));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(3.5, 6.5), ft_vector(0.0, 0.0), 10));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(3.5, 14.5), ft_vector(0.0, 0.0), 13));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(14.5, 20.5), ft_vector(0.0, 0.0), 10));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(18.5, 10.5), ft_vector(0.0, 0.0), 9));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(18.5, 11.5), ft_vector(0.0, 0.0), 9));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(18.5, 12.5), ft_vector(0.0, 0.0), 9));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(1.5, 1.5), ft_vector(0.0, 0.0), 8));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(15.5, 1.5), ft_vector(0.0, 0.0), 12));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(16.5, 1.8), ft_vector(0.0, 0.0), 12));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(16.2, 1.2), ft_vector(0.0, 0.0), 12));
	ft_push_back_sprites(&w->sprites, ft_create_sprites(ft_vector(3.5, 2.5), ft_vector(0.0, 0.0), 11));
